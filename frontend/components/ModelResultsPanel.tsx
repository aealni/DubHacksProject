...
export const ModelResultsPanel: React.FC<ModelResultsPanelProps> = ({ 
  ...
  return (
    <div 
      className={`panel-content relative bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden ${
    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-3 pr-24 rounded-t-lg border-b border-gray-200">
      ...
      {isExpanded ? (
        <div className="p-4 overflow-y-auto scrollable-content" style={{ height: panel.height - 60 }}>
          {error && (
            <div className="bg-gradient-to-br from-red-50 to-pink-50 border border-red-200 rounded-lg p-4 shadow-sm mb-4">
